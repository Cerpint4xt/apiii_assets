...
SQLITE_DEV = "sqlite:///" + str(HERE / "flask_api_assets_dev.db")
SQLITE_TEST = "sqlite:///" + str(HERE / "flask_api_assets_test.db")
SQLITE_PROD = "sqlite:///" + str(HERE / "flask_api_assets_prod.db")
