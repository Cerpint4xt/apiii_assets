"""Class definition for Asset model."""
...
class Asset(db.Model):
    """Asset model for a generic resource in a REST API."""
    ...
    # category = db.relationship("Category", backref=db.backref("asset"))

    def __repr__(self):
        return f"<Asset name={self.name}, info_url={self.info_url}>"
